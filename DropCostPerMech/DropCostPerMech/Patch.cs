...
namespace DropCostPerMech {
    ...
    public static class AAR_ContractObjectivesWidget_FillInObjectives {
        ...
        static void Postfix(AAR_ContractObjectivesWidget __instance) {
            try {
                MissionObjectiveResult missionObjectiveResult = new MissionObjectiveResult("Operation Costs: " + Mathf.FloorToInt(Fields.cbill) + " ¢", "7facf07a-626d-4a3b-a1ec-b29a35ff1ac0", false, true, ObjectiveStatus.Ignored, false);
